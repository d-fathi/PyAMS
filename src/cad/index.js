        ...
        "menus": [
            {
                ...
                "items": [
                    ...
                    { "label": "Save As..", "icon": images.white, "shortcut": " ", "action": "saveAsFile", "description": "Save as the current file" },
                    { "label": "separator" },
            ...
            },
            {
                "title": "Help",
                "items": [
                    { "label": "Help", "icon": images.white, "shortcut": "F1", "action": "help", "description": "Help" },
                    { "label": "Web Page", "icon": images.white, "shortcut": " ", "action": "webPage", "description": "Web Page" },
                    { "label": "Elements (Library)", "icon": images.white, "shortcut": " ", "action": "elements", "description": "Elements (Library)" },
                    { "label": "separator" },
                    { "label": "About", "icon": images.white, "shortcut": " ", "action": "about", "description": "About software" }
                ]
            }
        ],
